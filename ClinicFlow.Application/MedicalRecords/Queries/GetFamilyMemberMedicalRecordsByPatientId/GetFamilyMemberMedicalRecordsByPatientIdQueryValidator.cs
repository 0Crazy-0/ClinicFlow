...
public sealed class GetFamilyMemberMedicalRecordsByPatientIdQueryValidator
    : AbstractValidator<GetFamilyMemberMedicalRecordsByPatientIdQuery>
{
    public GetFamilyMemberMedicalRecordsByPatientIdQueryValidator()
    {
