...
public class GetMedicalRecordsByDoctorIdQueryValidatorTests
{
    ...
    {
        // Arrange
        var query = new GetMedicalRecordsByDoctorIdQuery(Guid.CreateVersion7(), 1, 10);
    ...
    {
        // Arrange
        var query = new GetMedicalRecordsByDoctorIdQuery(Guid.CreateVersion7(), pageNumber, 10);
    ...
    {
        // Arrange
        var query = new GetMedicalRecordsByDoctorIdQuery(Guid.CreateVersion7(), 1, pageSize);
