...
{
    public async Task Handle(DeactivateMedicalSpecialtyCommand request, CancellationToken ct)
    {
        var specialty =
        ...
        var hasActiveDoctors = await doctorRepository.HasActiveBySpecialtyIdAsync(specialty.Id, ct);
