...
public class AddRequiredTemplateToAppointmentTypeCommandHandlerTests
{
    ...
    private readonly AddRequiredTemplateToAppointmentTypeCommandHandler _sut;

    public AddRequiredTemplateToAppointmentTypeCommandHandlerTests()
    {
        ...
        _sut = new AddRequiredTemplateToAppointmentTypeCommandHandler(
