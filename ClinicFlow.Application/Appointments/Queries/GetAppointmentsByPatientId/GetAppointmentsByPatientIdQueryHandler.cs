...
public class GetAppointmentsByPatientIdQueryHandler(IAppointmentRepository appointmentRepository) : IRequestHandler<GetAppointmentsByPatientIdQuery, IEnumerable<AppointmentDto>>
{
