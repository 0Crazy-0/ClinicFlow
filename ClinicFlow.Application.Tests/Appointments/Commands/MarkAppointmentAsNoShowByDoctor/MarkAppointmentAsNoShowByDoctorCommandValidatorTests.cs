...
public class MarkAppointmentAsNoShowByDoctorCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new MarkAppointmentAsNoShowByDoctorCommand(Guid.Empty, Guid.CreateVersion7());
    ...
    {
        // Arrange
        var command = new MarkAppointmentAsNoShowByDoctorCommand(Guid.CreateVersion7(), Guid.Empty);
