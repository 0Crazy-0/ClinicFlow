...
public sealed class ScheduleByDoctorCommandValidator : AbstractValidator<ScheduleByDoctorCommand>
{
    public ScheduleByDoctorCommandValidator(TimeProvider timeProvider)
    {
