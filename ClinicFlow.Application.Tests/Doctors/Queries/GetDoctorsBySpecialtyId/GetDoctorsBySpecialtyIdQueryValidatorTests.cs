...
public class GetDoctorsBySpecialtyIdQueryValidatorTests
{
    ...
    {
        // Arrange
        var query = new GetDoctorsBySpecialtyIdQuery(Guid.NewGuid(), 1, 10);
    ...
    {
        // Arrange
        var query = new GetDoctorsBySpecialtyIdQuery(Guid.NewGuid(), pageNumber, 10);
    ...
    {
        // Arrange
        var query = new GetDoctorsBySpecialtyIdQuery(Guid.NewGuid(), 1, pageSize);
