...
namespace ClinicFlow.Domain.Entities
{
    public class Appointment : BaseEntity
    {
        ...
        public static Appointment Schedule(Patient patient, Doctor doctor, DateTime scheduledDate, TimeRange timeRange,
            Guid appointmentTypeId, IEnumerable<Appointment> existingDoctorAppointments)
        {
        ...
        {
            if (Status == AppointmentStatus.Cancelled || Status == AppointmentStatus.LateCancellation)
                return;
