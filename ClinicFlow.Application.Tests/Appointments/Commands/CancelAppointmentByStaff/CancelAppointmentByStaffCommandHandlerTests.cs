...
public class CancelAppointmentByStaffCommandHandlerTests
{
    ...
    {
        _sut = new CancelAppointmentByStaffCommandHandler(_appointmentRepositoryMock.Object, _doctorRepositoryMock.Object, _specialtyRepositoryMock.Object, 
    ...
    {
        // Arrange
        var command = new CancelAppointmentByStaffCommand(Guid.NewGuid(), Guid.NewGuid(), UserRole.Admin, "Staff reason");
    ...
    {
        var doctor = Doctor.Create(Guid.NewGuid(), MedicalLicenseNumber.Create("1234567"), specialtyId, "555-1234", 101);
