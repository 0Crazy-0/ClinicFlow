...
/// <param name="Category">The clinical area of the appointment (e.g. Pediatrics, Cardiology).</param>
/// <param name="Purpose">The clinical purpose of the appointment (e.g. Checkup, Procedure).</param>
